  ...
  return (
    <div className="flex min-h-screen">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        {/* Gradient background */}
        <div className="absolute inset-0 bg-gradient-to-br from-slate-900 via-accent-900 to-slate-900" />
        ...
        <motion.div
          ...
          className="absolute top-20 right-20 w-96 h-96 bg-accent-500/30 rounded-full blur-3xl"
        />
        <motion.div
          animate={{
            scale: [1.2, 1, 1.2],
          ...
          className="absolute bottom-20 left-20 w-96 h-96 bg-primary-500/30 rounded-full blur-3xl"
        />
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-12">
              <div className="relative">
                <div className="absolute inset-0 bg-gradient-to-r from-accent-500 to-primary-500 rounded-xl blur-lg opacity-50" />
                <div className="relative flex h-12 w-12 items-center justify-center rounded-xl bg-gradient-to-r from-accent-500 to-primary-500 shadow-lg">
            ...
            <p className="text-lg text-slate-300 mb-8 max-w-md">
              Join thousands of developers who trust DocuGen for their documentation needs.
            </p>
      ...
      <div className="flex w-full lg:w-1/2 items-center justify-center bg-slate-50 px-6 py-12">
        ...
        >
          ...
          <div className="text-center mb-8">
            ...
            <p className="mt-2 text-slate-500">Start generating documentation today</p>
          </div>
